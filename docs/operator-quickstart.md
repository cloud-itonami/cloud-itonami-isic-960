# Operator Quickstart — read-only

Shortest path from clone to a verified local dry-run for **ISIC 960** (`cloud-itonami-isic-960`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-960.git
cd cloud-itonami-isic-960
```
...
- Likely source path: `personalcareops.governor.cljc`
