# Business Model: Personal-Care Salon/Service Administrative Coordination
...
- ISIC Rev.5: `` — Personal-Care Salon/Service Administrative Coordination
- Domain: `:services/personal-care-coordination`
- Social impact: :client-safety :operational-efficiency :administrative-transparency
- Actor: `:personalcareops-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :services/personal-care-coordination — who wants
...
One managed tenant (:services/personal-care-coordination):
...
- Do not bypass the `:personalcareops-governor` for production decisions.
